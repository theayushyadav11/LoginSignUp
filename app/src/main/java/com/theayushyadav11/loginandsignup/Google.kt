...
import com.theayushyadav11.loginandsignup.databinding.ActivityGoogleBinding
...
//                    val name= user?.displayName.toString()+ user?.uid
//                    Toast.makeText(this@Google, "$name", Toast.LENGTH_SHORT).show()
//                } else {
//
//                }
//            }
